 ...
 * @version $Id: customers.php for group pricing per item 2019-10-02 15:13:51Z webchills $
 */
  ...
  <body onLoad="init()">
    ...
    $group_array[] = array('id'=>0, 'text'=>TEXT_NONE);
      ...
      if(in_array($group_array_query->fields['group_name'], array(GROUP_PRICE_PER_ITEM1, GROUP_PRICE_PER_ITEM2, GROUP_PRICE_PER_ITEM3, GROUP_PRICE_PER_ITEM4))) {
        $group_array[] = array('id' => $group_array_query->fields['group_id'], 'text' => $group_array_query->fields['group_name'] . '&nbsp;-&nbsp;' . GROUP_PRICE_PER_ITEM_TEXT . '&nbsp;' . $group_array_query->fields['group_percentage'] . '%');
      } else {
