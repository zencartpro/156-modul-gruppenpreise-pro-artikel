 ...
 * @version $Id: group_pricing.php for group pricing per item 2019-10-02 15:13:51Z webchills $
 */
...
<html <?php echo HTML_PARAMS; ?>>
  ...
  <body onload="init()">
    ...
    <div class="container-fluid">
      ...
      <?php echo GROUP_PRICE_PER_ITEM_ADMIN_NOTE; ?>
      <div class="row">
        <!-- body_text //-->
...
//    zen_redirect(zen_href_link(FILENAME_CUSTOMERS, 'cID=' . $_GET['cID'] . (isset($_GET['page']) ? '&page=' . $_GET['page'] : ''), 'NONSSL'));
              ...
              <td class="dataTableContent"><?php echo $group['group_name']; ?></td>
                <td class="dataTableContent"><?php 
                       if(in_array($groups->fields['group_name'], array(GROUP_PRICE_PER_ITEM1, GROUP_PRICE_PER_ITEM2, GROUP_PRICE_PER_ITEM3, GROUP_PRICE_PER_ITEM4))) {
                           echo GROUP_PRICE_PER_ITEM_TEXT . '&nbsp;' . $groups->fields['group_percentage'] . '%';
                       } else {
