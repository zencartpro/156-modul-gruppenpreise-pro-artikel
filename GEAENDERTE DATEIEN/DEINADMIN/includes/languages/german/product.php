 ...
 * @version $Id: product.php for group pricing by item 2019-09-19 07:58:04Z webchills $
 */
...
define('TEXT_PRODUCTS_GROUP_A_PRICE_NET',   GROUP_PRICE_PER_ITEM1 . ' Nettopreis:');
define('TEXT_PRODUCTS_GROUP_A_PRICE_GROSS', GROUP_PRICE_PER_ITEM1 . ' Bruttopreis:');
define('TEXT_PRODUCTS_GROUP_B_PRICE_NET',   GROUP_PRICE_PER_ITEM2 . ' Nettopreis:');
define('TEXT_PRODUCTS_GROUP_B_PRICE_GROSS', GROUP_PRICE_PER_ITEM2 . ' Bruttopreis:');
define('TEXT_PRODUCTS_GROUP_C_PRICE_NET',   GROUP_PRICE_PER_ITEM3 . ' Nettopreis:');
define('TEXT_PRODUCTS_GROUP_C_PRICE_GROSS', GROUP_PRICE_PER_ITEM3 . ' Bruttopreis:');
define('TEXT_PRODUCTS_GROUP_D_PRICE_NET',   GROUP_PRICE_PER_ITEM4 . ' Nettopreis:');
define('TEXT_PRODUCTS_GROUP_D_PRICE_GROSS', GROUP_PRICE_PER_ITEM4 . ' Bruttopreis:');
