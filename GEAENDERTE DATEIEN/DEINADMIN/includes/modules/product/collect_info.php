 ...
 * @version $Id: collect_info.php for group pricing per item 2019-10-02 15:24:50Z webchills $
 */
...
$parameters = array(
  ...
  'products_group_a_price' => '0.0000',
  'products_group_b_price' => '0.0000',
  'products_group_c_price' => '0.0000',
  'products_group_d_price' => '0.0000',
  ...
  <div class="well" style="color: #31708f;background-color: #d9edf7;border-color: #bce8f1;;padding: 10px 10px 0 0;">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9 col-md-6">
          ...
          <div class="form-group">
        <?php echo zen_draw_label(TEXT_PRODUCTS_GROUP_A_PRICE_NET, 'products_group_a_price', 'class="col-sm-3 control-label"'); ?>
      <div class="col-sm-9 col-md-6">
          <?php echo zen_draw_input_field('products_group_a_price', $pInfo->products_group_a_price, 'onkeyup="updateGross()" class="form-control"'); ?>
      </div>
    </div>
    <div class="form-group">
        <?php echo zen_draw_label(TEXT_PRODUCTS_GROUP_A_PRICE_GROSS, 'products_group_a_price_gross', 'class="col-sm-3 control-label"'); ?>
      <div class="col-sm-9 col-md-6">
          <?php echo zen_draw_input_field('products_group_a_price_gross', $pInfo->products_group_a_price_gross, 'onkeyup="updateNet()" class="form-control"'); ?>
      </div>
    </div>   
          <?php
            }
          ...
          ?>
               <div class="form-group">
        <?php echo zen_draw_label(TEXT_PRODUCTS_GROUP_B_PRICE_NET, 'products_group_b_price', 'class="col-sm-3 control-label"'); ?>
      <div class="col-sm-9 col-md-6">
          <?php echo zen_draw_input_field('products_group_b_price', $pInfo->products_group_b_price, 'onkeyup="updateGross()" class="form-control"'); ?>
      </div>
    </div>
    <div class="form-group">
        <?php echo zen_draw_label(TEXT_PRODUCTS_GROUP_B_PRICE_GROSS, 'products_group_b_price_gross', 'class="col-sm-3 control-label"'); ?>
      <div class="col-sm-9 col-md-6">
          <?php echo zen_draw_input_field('products_group_b_price_gross', $pInfo->products_group_b_price_gross, 'onkeyup="updateNet()" class="form-control"'); ?>
      </div>
    </div>
          <?php
            }
          ...
          ?>
              <div class="form-group">
        <?php echo zen_draw_label(TEXT_PRODUCTS_GROUP_C_PRICE_NET, 'products_group_c_price', 'class="col-sm-3 control-label"'); ?>
      <div class="col-sm-9 col-md-6">
          <?php echo zen_draw_input_field('products_group_c_price', $pInfo->products_group_c_price, 'onkeyup="updateGross()" class="form-control"'); ?>
      </div>
    </div>
    <div class="form-group">
        <?php echo zen_draw_label(TEXT_PRODUCTS_GROUP_C_PRICE_GROSS, 'products_group_c_price_gross', 'class="col-sm-3 control-label"'); ?>
      <div class="col-sm-9 col-md-6">
          <?php echo zen_draw_input_field('products_group_c_price_gross', $pInfo->products_group_c_price_gross, 'onkeyup="updateNet()" class="form-control"'); ?>
      </div>
    </div>
          <?php
            }
          ...
          ?>
               <div class="form-group">
        <?php echo zen_draw_label(TEXT_PRODUCTS_GROUP_D_PRICE_NET, 'products_group_d_price', 'class="col-sm-3 control-label"'); ?>
      <div class="col-sm-9 col-md-6">
          <?php echo zen_draw_input_field('products_group_d_price', $pInfo->products_group_d_price, 'onkeyup="updateGross()" class="form-control"'); ?>
      </div>
    </div>
    <div class="form-group">
        <?php echo zen_draw_label(TEXT_PRODUCTS_GROUP_D_PRICE_GROSS, 'products_group_d_price_gross', 'class="col-sm-3 control-label"'); ?>
      <div class="col-sm-9 col-md-6">
          <?php echo zen_draw_input_field('products_group_d_price_gross', $pInfo->products_group_d_price_gross, 'onkeyup="updateNet()" class="form-control"'); ?>
      </div>
    </div>
          <?php
            }
