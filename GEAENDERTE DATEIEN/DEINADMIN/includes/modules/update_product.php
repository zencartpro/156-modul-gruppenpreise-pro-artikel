 ...
 * @version $Id: update_product.php for group pricing per item 2019-09-19 08:49:16Z webchills $
 */
...
if (isset($_POST['edit']) && $_POST['edit'] == 'edit') {
  ...
  $sql_data_array = array(
    ...
    'products_group_a_price' => convertToFloat($_POST['products_group_a_price']),
    'products_group_b_price' => convertToFloat($_POST['products_group_b_price']),
    'products_group_c_price' => convertToFloat($_POST['products_group_c_price']),
    'products_group_d_price' => convertToFloat($_POST['products_group_d_price']),  
