 ...
 * @version $Id: tpl_product_info_display.php for group pricing by item 2019-07-05 10:28:24Z webchills $
 */
...
// base price
  ...
  echo $one_time . ((zen_has_product_attributes_values((int)$_GET['products_id']) and $flag_show_product_info_starting_at == 1) ? TEXT_BASE_PRICE : '') . zen_get_products_display_price((int)$_GET['products_id']) . zen_get_products_retail_display_price((int)$_GET['products_id']);
?></h2>
